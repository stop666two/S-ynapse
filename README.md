...
**全配置驱动**
- 13 个 JSON5 配置文件（支持注释），**2000+ 可配置项**（实测 2386 项），逐字段中文注释（含可填值/推荐值/禁用值/注意事项）
- `features.json5` 功能总控域：**92 个模块、744 个配置项**，每项功能均可开/关/微调；`tuning.json5` UI 微调层（30 分类 / 196 项）
...
├── features.json5     # 功能总控（92 模块/744 项，可开关/微调，可选文件）
